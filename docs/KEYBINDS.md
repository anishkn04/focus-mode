...
--  SUPER+F pick+start · SUPER+SHIFT+F quiz-stop · SUPER+ALT+F status

hl.bind(mainMod .. "+F", hl.dsp.exec_cmd("$HOME/.config/hypr/scripts/focus-pick.sh"), { description = "Focus: Start session (picker)" })
